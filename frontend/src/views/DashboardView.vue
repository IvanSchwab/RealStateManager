  ...
  <div>
    ...
    <div class="pia-page-header">
      <div class="pia-page-title-block">
        ...
        <div class="pia-page-subtitle">
          <span>Resumen de ingresos e indicadores</span>
    ...
    <div class="pia-grid pia-grid-4" style="margin-bottom:var(--gap)">
      ...
      <div class="pia-kpi">
        ...
        <div class="pia-kpi-meta"><span>vs mes anterior</span></div>
      </div>
      ...
      <div class="pia-kpi">
        ...
        <div class="pia-kpi-meta"><span>{{ paymentDistribution.pendingCount }} pagos pendientes</span></div>
      </div>
      ...
      <div class="pia-kpi">
        <div class="pia-kpi-head">
          ...
          <span class="pia-chip down">{{ incomeKPIs.overdueCount }} vencidos</span>
        </div>
        <div class="pia-kpi-value">
          <span class="pia-currency">$</span>
          <span>{{ formatKpiValue(incomeKPIs.overdueAmount) }}</span>
        </div>
        <div class="pia-kpi-meta"><span>requiere atención</span></div>
      </div>
      ...
      <div class="pia-kpi">
        ...
        <div class="pia-kpi-meta"><span>pagos este período</span></div>
      </div>
    </div>
      ...
      <div class="pia-card pia-card-lg">
        <div class="pia-card-head">
          <div>
            ...
            <div class="pia-card-sub" style="margin-top:4px;padding-left:30px">Últimos {{ recentPayments.length }} registros</div>
          </div>
          ...
          <table class="pia-tbl">
            ...
            <tbody>
              ...
              <tr v-if="!loading && recentPayments.length === 0">
                <td colspan="4">
                  <div class="pia-empty" style="padding:20px">Sin pagos recientes</div>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div class="pia-card pia-card-lg">
        <div class="pia-card-head">
          <div>
            ...
            <div class="pia-card-sub" style="margin-top:4px;padding-left:30px">Próximos 90 días</div>
          </div>
        ...
        <div style="display:flex;flex-direction:column">
          ...
          >
            ...
            <div style="text-align:right">
              ...
              <span class="pia-chip" :class="c.daysRemaining <= 15 ? 'warn' : 'neutral'" style="margin-top:3px">en {{ c.daysRemaining }} días</span>
            </div>
          </div>
    ...
    <div class="pia-grid pia-grid-chart" style="margin-bottom:var(--gap)">
      ...
      <div class="pia-card pia-card-lg">
        <div class="pia-card-head">
          <div>
            <div class="pia-card-title">Ingresos por mes</div>
            <div class="pia-card-sub" style="margin-top:4px">Cobrado vs pendiente — últimos {{ chartPeriod }} meses</div>
          </div>
        ...
        <div style="display:flex;gap:20px;justify-content:center;margin-top:12px;font-size:12px;color:var(--pia-text-3)">
          <span style="display:flex;align-items:center;gap:6px">
            <span style="width:10px;height:10px;border-radius:2px;background:var(--brand-700);display:inline-block"></span> Cobrado
          </span>
          <span style="display:flex;align-items:center;gap:6px">
            <span style="width:10px;height:10px;border-radius:2px;background:var(--amber);display:inline-block"></span> Pendiente
          </span>
        </div>
      </div>
      ...
      <div class="pia-card pia-card-lg">
        <div class="pia-card-head">
          <div>
            <div class="pia-card-title">Distribución de pagos</div>
          ...
          <div style="position:relative;flex-shrink:0">
            ...
            <div style="position:absolute;inset:0;display:grid;place-items:center">
              <div style="text-align:center">
                <div style="font-size:11px;color:var(--pia-text-3);letter-spacing:0.04em;text-transform:uppercase;font-weight:600">Total</div>
          ...
          <div style="display:flex;flex-direction:column;gap:10px;flex:1;min-width:0">
            <div v-for="(seg, i) in donutSegments" :key="i"
              ...
              <div style="flex:1;min-width:0">
                ...
                <div style="font-size:11px;color:var(--pia-text-3)">{{ seg.count }} {{ seg.count === 1 ? 'pago' : 'pagos' }}</div>
              </div>
    ...
    <div class="pia-section-divider" style="margin-bottom:14px">
      <span style="font-size:11px;font-weight:600;color:var(--pia-text-3);letter-spacing:0.1em;text-transform:uppercase">Datos de mercado</span>
      <div class="pia-section-divider-line" />
      <span style="font-size:11px;color:var(--pia-text-4)">Contexto económico</span>
    </div>
    <div class="pia-grid pia-grid-3" style="margin-bottom:var(--gap)">
      ...
      <div class="pia-card">
        ...
        <div style="display:flex;gap:16px">
          <div style="flex:1">
            <div style="font-size:10.5px;color:var(--pia-text-4);letter-spacing:0.06em;text-transform:uppercase;font-weight:600">Compra</div>
          ...
          <div class="pia-vr" />
          <div style="flex:1">
            <div style="font-size:10.5px;color:var(--pia-text-4);letter-spacing:0.06em;text-transform:uppercase;font-weight:600">Venta</div>
            <div style="font-size:22px;font-weight:500;letter-spacing:-0.02em;color:var(--pia-text);line-height:1.1;margin-top:2px;font-variant-numeric:tabular-nums">
        ...
        <div style="font-size:11px;color:var(--pia-text-4);margin-top:10px;display:flex;align-items:center;gap:5px">
          ...
          {{ economicIndicators.dolarBlue.fecha || 'Sin datos' }}
        </div>
      </div>
      ...
      <div class="pia-card">
        ...
        <div style="font-size:11px;color:var(--pia-text-4);margin-top:10px;display:flex;align-items:center;gap:5px">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="11" height="11"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
          {{ economicIndicators.dolarOficial.fecha || 'Sin datos' }}
        </div>
      </div>
      ...
      <div class="pia-card" style="position:relative;overflow:hidden">
        ...
        <div style="display:flex;align-items:baseline;gap:10px">
          ...
          <span class="pia-chip warn">↑ vs anterior</span>
        </div>
      </div>
    </div>
...
const donutSegments = computed(() => [
  { label: 'Cobrados', count: paymentDistribution.value.paidCount, amount: paymentDistribution.value.paid, color: 'var(--sage)' },
  { label: 'Pendientes', count: paymentDistribution.value.pendingCount, amount: paymentDistribution.value.pending, color: 'var(--amber)' },
  { label: 'Vencidos', count: paymentDistribution.value.overdueCount, amount: paymentDistribution.value.overdue, color: 'var(--terra)' },
])
